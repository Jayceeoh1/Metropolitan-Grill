...
function NeonBox({ catId, products, onOpen }) {
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0 ml-2">
              <div className="text-right">
                {p.promo_price && (
                  <p className="text-[#7a6e66] text-xs line-through leading-none">{p.price} lei</p>
                )}
...
export default function MenuPage() {
  ...
  const renderSection = (catIds) =>
    catIds.map(id => (
      <NeonBox key={id} catId={id} products={products} onOpen={setModalProduct} />
    ))
  ...
  return (
    <div className="page-enter pt-16 min-h-screen" style={{ background: '#080808' }}>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(180deg, #1a0800 0%, #0d0400 60%, #080808 100%)',
          borderBottom: '1px solid rgba(243,156,18,0.2)',
        }}
      >
        {/* Background flames effect */}
        <div className="absolute inset-0 pointer-events-none" style={{
          backgroundImage: 'radial-gradient(ellipse at 15% 50%, rgba(192,57,43,0.15) 0%, transparent 50%), radial-gradient(ellipse at 85% 50%, rgba(192,57,43,0.15) 0%, transparent 50%)',
        }} />

        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1
            className="font-bebas leading-none mb-0"
            style={{
              fontSize: 'clamp(48px, 10vw, 110px)',
              color: '#fff',
              textShadow: '0 0 30px rgba(243,156,18,0.3), 0 0 60px rgba(243,156,18,0.1)',
              letterSpacing: '4px',
            }}
          >
            METROPOLITAN
          ...
          <h2
            ...
            style={{
              ...
              color: '#e74c3c',
              textShadow: '0 0 20px rgba(231,76,60,0.6), 0 0 40px rgba(231,76,60,0.3)',
              letterSpacing: '6px',
            }}
          >
            SHAORMA & GRILL
          ...
          {tabs.map(tab => (
            <button
              ...
              style={activeTab === tab.id ? {
                ...
                color: '#000',
                boxShadow: `0 0 15px ${tab.color}60`,
              } : {
              ...
              <div className="mb-8">
                {activeTab === 'all' && (
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <h2 className="font-bebas text-2xl sm:text-3xl tracking-[5px]" style={{ color: '#f1c40f', textShadow: '0 0 20px rgba(241,196,15,0.5)' }}>
                      🌯 SHAORMA
                    </h2>
              ...
              <div className="mb-8">
                {activeTab === 'all' && (
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <h2 className="font-bebas text-2xl sm:text-3xl tracking-[5px]" style={{ color: '#3498db', textShadow: '0 0 20px rgba(52,152,219,0.5)' }}>
                      ★ SPECIALITATI ★
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {renderSection(specialitatiCats)}
                </div>
              </div>
            )}
              ...
              <div className="mb-8">
                {activeTab === 'all' && (
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <h2 className="font-bebas text-2xl sm:text-3xl tracking-[5px]" style={{ color: '#e67e22', textShadow: '0 0 20px rgba(230,126,34,0.5)' }}>
                      🍟 CRISPY & BAUTURI
                    </h2>
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: item.accent ? `0 0 20px ${item.color}20` : 'none',
                    }}
                  >
                    <span className="text-2xl">{item.icon}</span>
                    <span
                      className="font-condensed font-bold text-sm uppercase tracking-wide"
